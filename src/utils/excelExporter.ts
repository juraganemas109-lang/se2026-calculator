...
const EXCEL_HEADERS = [
  ...
  'Jenis Penjualan',
  'Harga Acuan (Rp)',
  'Estimasi Nilai Jual Sawah (Rp)',
  'Estimasi Nilai Jual (Rp)',
  'Selisih Nilai Tambah Pengolahan (Rp)',
  'Metode Perhitungan',
  'Jenis Analisis',
  'Prajangan - Jumlah Pohon',
  'Prajangan - Produksi Kg',
  'Prajangan - Harga Kg',
  'Prajangan - Pendapatan',
  'Prajangan - Luas m2',
  'Prajangan - Luas Ha',
  'Pertanian - Jumlah Pohon',
  'Pertanian - Produksi Kg',
  'Pertanian - Harga Kg',
  'Pertanian - Nilai Jual Sawah',
  'Pertanian - Luas m2',
  'Pertanian - Luas Ha'
];
...
function flattenRecord(record: BusinessRecord) {
  return [
    ...
    record.analysis?.estimasiBatang || '',
    record.analysis?.estimasiPohon || '',
    record.analysis?.jumlahSak || '',
    record.analysis?.produksiKg || '',
    record.analysis?.estimasiLuasM2 || '',
    record.analysis?.estimasiLuasHa || '',
    record.analysis?.modeKepadatan || '',
    record.analysis?.jenisTembakau || '',
    record.analysis?.modeTanam || '',
    record.analysis?.jenisPenjualan || '',
    record.analysis?.hargaAcuanKg || '',
    record.analysis?.estimasiNilaiJualSawah || '',
    record.analysis?.estimasiNilaiJual || '',
    record.analysis?.selisihNilaiTambahPengolahan || '',
    record.analysis?.metodePerhitungan || '',
    record.analysis?.jenisAnalisis || '',
    record.analysis?.jumlahPohon || '',
    record.analysis?.produksiKg || '',
    record.analysis?.hargaPerKg || '',
    record.analysis?.pendapatanRajangan || '',
    record.analysis?.luasM2 || '',
    record.analysis?.luasHa || '',
    record.analysis?.jenisAnalisis === 'PERTANIAN_TEMBAKAU' ? record.analysis?.jumlahPohon || '' : '',
    record.analysis?.jenisAnalisis === 'PERTANIAN_TEMBAKAU' ? record.analysis?.produksiKg || '' : '',
    record.analysis?.jenisAnalisis === 'PERTANIAN_TEMBAKAU' ? record.analysis?.hargaAcuanKg || '' : '',
    record.analysis?.jenisAnalisis === 'PERTANIAN_TEMBAKAU' ? record.analysis?.nilaiJualSawah || '' : '',
    record.analysis?.jenisAnalisis === 'PERTANIAN_TEMBAKAU' ? record.analysis?.luasM2 || '' : '',
    record.analysis?.jenisAnalisis === 'PERTANIAN_TEMBAKAU' ? record.analysis?.luasHa || '' : ''
  ];
}
